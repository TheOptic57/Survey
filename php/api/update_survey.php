...
$statement = $connection->prepare(
    "UPDATE Survey
     SET Title = ?, Description = ?, Start_Date = ?, End_Date = ?, email = ?, Is_Complete = ?
     WHERE Sid = ?;");
$statement->bind_param("sssssii", $in_data["Title"], $in_data["Description"], $in_data["Start_Date"], $in_data["End_Date"], $in_data["email"], $in_data["Is_Complete"], $in_data["Sid"]);
