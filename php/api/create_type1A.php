...
$statement = $connection->prepare("INSERT INTO T1Answers (Answer, T1id) VALUES (?, ?);");
$statement->bind_param("ii", $in_data["Answer"], $in_data["T1id"]);

// If statement is successful, then return JSON response
if($statement->execute()) {
    send_JSON_response("Type 1 question Answered!"); 
}
