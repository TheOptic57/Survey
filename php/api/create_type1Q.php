...
$statement = $connection->prepare("INSERT INTO T1Questions (Question, Sid) VALUES (?, ?);");
$statement->bind_param("si", $in_data["Question"], $in_data["Sid"]);

// If statement is successful, then return JSON response
if($statement->execute()) {
    send_JSON_response("Type 1 Question created!"); 
}
